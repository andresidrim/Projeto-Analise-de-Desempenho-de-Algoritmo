...
DELETE FROM PC_SPECS CASCADE;
DELETE FROM QUICKSORT CASCADE;
DELETE FROM MERGESORT CASCADE;
DELETE FROM BUBBLESORT CASCADE;

DROP TABLE PC_SPECS CASCADE;
DROP TABLE BUBBLESORT CASCADE;
DROP TABLE MERGESORT CASCADE;
DROP TABLE QUICKSORT CASCADE;